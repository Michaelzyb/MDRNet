...
class DeepLabV3(nn.Module):
    def __init__(self, in_channel, num_classes):
        ...
        self.encoder = ResNet50_OS16() # NOTE! specify the type of ResNet here
        ...
        self.encoder.resnet[0] = nn.Conv2d(in_channel, 64, kernel_size=7, stride=2, padding=3, bias=False)
    ...
    def forward(self, x):
        ...
        feature_map = self.encoder(x) # (shape: (batch_size, 512, h/16, w/16)) (assuming self.resnet is ResNet18_OS16 or ResNet34_OS16. If self.resnet is ResNet18_OS8 or ResNet34_OS8, it will be (batch_size, 512, h/8, w/8). If self.resnet is ResNet50-152, it will be (batch_size, 4*512, h/16, w/16))
